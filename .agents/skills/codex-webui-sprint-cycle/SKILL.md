...
- For TypeScript or TSX edits in `apps/frontend-bff` or `apps/codex-runtime`, treat the touched app's `npm run check` as part of the minimum targeted validation evidence expected from `worker`
