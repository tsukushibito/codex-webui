  ...
  return (
    <section
      ...
      className={[
        ...
        .join(" ")}
    >
      {notificationFeedback || backgroundPriorityNotice ? (
        <div className="navigation-notice-stack">
          {notificationFeedback ? (
            <p
              aria-live={notificationFeedback.tone === "error" ? "assertive" : "polite"}
              className={`feedback-note navigation-feedback-note navigation-feedback-note-notification ${notificationFeedback.tone}`}
              role={notificationFeedback.tone === "error" ? "alert" : "status"}
            >
        ...
        <>
          ...
          <details className="workspace-switcher">
            ...
            <div className="workspace-switcher-control">
              ...
              {workspaceFeedback ? (
                <p
                  aria-live={workspaceFeedback.tone === "error" ? "assertive" : "polite"}
                  className={`feedback-note navigation-feedback-note ${workspaceFeedback.tone}`}
          ...
          <div className="thread-list">
            ...
            {threadListFeedback ? (
              <p
                aria-live={threadListFeedback.tone === "error" ? "assertive" : "polite"}
                className={`feedback-note navigation-feedback-note ${threadListFeedback.tone}`}
                role={threadListFeedback.tone === "error" ? "alert" : "status"}
              >
                {threadListFeedback.message}
              </p>
            ) : null}
