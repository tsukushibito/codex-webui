...
- update `index.md` when maintained navigation, discoverability, or content summaries materially change
- append `log.md` when the maintained wiki materially changes
...
- `ingest`: if a maintained page is added, moved, removed, or materially changes how maintained knowledge should be discovered, update `index.md`
